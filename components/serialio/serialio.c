...
#define ASC_ERROR_MASK                                                                                                 \
  ((IFX_ASCLIN_FLAGS_PE_MSK << IFX_ASCLIN_FLAGS_PE_OFF) | (IFX_ASCLIN_FLAGS_FE_MSK << IFX_ASCLIN_FLAGS_FE_OFF) |       \
...
void SERIALIO_Init(sint32 baudrate)
{
  ...
  IfxAsclin_setBitTiming(SERIALIO.asclin, baudrate, IfxAsclin_OversamplingFactor_16, IfxAsclin_SamplePointPosition_8,
