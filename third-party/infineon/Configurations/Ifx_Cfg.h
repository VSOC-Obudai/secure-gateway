...
#define  ISR_PRIORITY_STM0_TICK     10

#define  CPU_WHICH_SERVICE_TLF 0
#define  ISR_PRIORITY_TLF_QSPI_TX   20
#define  ISR_PRIORITY_TLF_QSPI_RX   21
#define  ISR_PRIORITY_TLF_QSPI_ER   22

#define ISR_PRIORITY_ADC 2
